...
CONFIG = {
    ...
    "THEMES": {
        "classic": {
            ...
            "suggest_bg": "#e8eaf6", "suggest_fg": "#222222", "suggest_hover": "#4a90d9",
        ...
        "dark": {
            ...
            "key_border": "#333333", "text_bg": "#0d0d1a", "text_fg": "#FFFFFF",
            "suggest_bg": "#0f3460", "suggest_fg": "#FFFFFF", "suggest_hover": "#4a90d9",
            "status_bg": "#0d0d1a", "status_fg": "#aaaaaa", "dot_color": "#ff0000",
        },
        "light": {
            "bg": "#f0f0f0", "key_bg": "#FFFFFF", "key_fg": "#000000",
            "key_hover": "#4a90d9", "key_dwell": "#27ae60", "key_special": "#dde3f0",
            "key_border": "#cccccc", "text_bg": "#FFFFFF", "text_fg": "#000000",
            "suggest_bg": "#dde3f0", "suggest_fg": "#000000", "suggest_hover": "#4a90d9",
        ...
        "high_contrast": {
            ...
            "suggest_bg": "#111111", "suggest_fg": "#FFFF00", "suggest_hover": "#FF0000",
...
LAYOUTS = {
    "qwerty": [
        ...
        ["Z","X","C","V","B","N","M",",","."],
        ["SPACE","CLEAR","SPEAK","SAVE","SETTINGS"],
    ],
    "abc": [
        ["A","B","C","D","E","F","G","H","I","J","<"],
...
BOTTOM_ROW = {"SPACE", "CLEAR", "SPEAK", "SAVE", "SETTINGS"}
...
class VirtualKeyboard(tk.Frame):
    def __init__(self, parent, settings=None, on_text_change=None,
        ...
        self.theme = CONFIG["THEMES"].get(self.theme_name, CONFIG["THEMES"]["classic"])
        ...
        for row_idx, row in enumerate(self.layout):
            ...
            if row_idx == len(self.layout) - 1:
                ...
                for col_idx, label in enumerate(row):
                    ...
                    self._draw_key(x, y, sp_w, kh, label, t["key_special"], t["key_fg"])
    ...
    def update_gaze(self, gaze_x, gaze_y):
        ...
        self._debug_var.set(
            f"Canvas px: ({int(local_x)}, {int(local_y)})  Key: {self._hovered_key or 'none'}{elapsed_str}"
        )
    ...
    def _trigger_key(self, label):
        ...
        if label in self._key_rects:
            ...
            flash = self.canvas.create_rectangle(x, y, x + w, y + h, fill="#ffffff", outline="", tags="flash")
        ...
        if self._key_callback:
            lk = {"<": "BKSP", "ENTER": "ENTER"}.get(label, label)
    ...
    def _update_arc(self, label, progress):
        ...
        x, y, w, h = self._key_rects[label]
        bg = self.theme["key_special"] if label in SPECIAL_KEYS else self.theme["key_bg"]
        self._draw_key(x, y, w, h, label, bg, self.theme["key_fg"], arc_progress=progress, is_hovered=True)
    ...
    def apply_theme(self, theme_name):
        ...
        self.text_area.configure(bg=self.theme["text_bg"], fg=self.theme["text_fg"], insertbackground=self.theme["text_fg"])
